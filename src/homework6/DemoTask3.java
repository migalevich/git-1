...
public class DemoTask3 {
    public static void main(String[] args) {
        ...
        try (OutputStreamWriter writerFile = new OutputStreamWriter(new FileOutputStream("test3.txt"));
            ...
            writerFile.write("Peter was a little annoyed with them for knowing so much, but if he wanted to lord it over them his triumph was at hand, for have I not told you that anon fear fell upon them?\n"+
            ...
            writerFile.close();
                ...
                System.out.println(middleware.check(bufferedReader));
